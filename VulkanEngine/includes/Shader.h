...
class Shader {
 public:
    explicit Shader(const std::string_view vertexShaderPath, const std::string_view fragmentShaderPath,
 ...
 private:
    /// Set of possible shader types
    enum class ShaderType { VertexShader = 0, FragmentShader = 1, GeometryShader = 2 };
    ...
    ShaderDefines m_defines;  ///< Compile-time shader's definitions
    bool m_isValid = true;
