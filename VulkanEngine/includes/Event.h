...
namespace sge {
enum class EventType { WindowResize = 0, KeyPressed, Scroll, EventsCount };
...
class EventScroll final : public BaseEvent {
 public:
    EventScroll(const double new_x, const double new_y) : x(new_x), y(new_y) {}
    EventType get_type() const override { return EventType::Scroll; }
